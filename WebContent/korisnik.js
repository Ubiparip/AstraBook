...
function ispisiMojePodatke(user){
	...
	let button = $('<button id="izmeniButton" style="background-color: silver important!;">Izmeni podatke</button>');
...
function ispisiRezervacijaZakazivanje(apartman){
	let div = $('<div id="rezervacijaDiv' + apartman.id + '" style="margin-left: 20px; margin-right: 20px; border-style: solid;background-color: silver important!; padding-left: 20px"></div>');
...
function ispisiUnosKomentar(apartman){
	let div = $('<div id="komentarDiv' + apartman.id + '" style="margin-left: 20px; margin-right: 20px; border-style: solid;background-color: silver important!; padding-left: 20px"></div>');
